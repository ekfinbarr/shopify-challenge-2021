    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 text-center">
          ...
          <p class="text-muted mb-5">This page was not found. <br /> You may have mistyped the address or the page may
            have moved.</p>

          <a href="{{ route('home') }}" class="btn btn-lg btn-primary mt-4">Take me Home</a>
        </div>
      </div>
    </div>
    <!-- end container -->
