  ...
  <div class="col-md-12">
    <nav aria-label="breadcrumb" class="float-right mt-1">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ trans('New Class') }}</li>
      </ol>
    </nav>
    <h4 class="mb-1 mt-0">{{ trans('New Class') }}</h4>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title mt-0 mb-1">{{ trans('Class form') }}</h4>
        <p class="sub-header">{{ trans('Fill in the form to add a new class') }}</p>
