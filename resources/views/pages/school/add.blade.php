  ...
  <div class="col-md-12">
    <nav aria-label="breadcrumb" class="float-right mt-1">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ trans('New School') }}</li>
      </ol>
    </nav>
    <h4 class="mb-1 mt-0">{{ trans('New School') }}</h4>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title mt-0 mb-1">{{ trans('School form') }}</h4>
          ...
          <div class="col-12">
            <form action="{{ route('schools.store') }}" method="post">
              ...
              <div class="form-group col-lg-8">
                ...
                <input type="text" name="name" class="form-control" id="sw-dots-userName" required
              ...
              <div class="form-group col-lg-8">
                ...
                <input type="email" name="email" class="form-control" id="sw-dots-userName" placeholder="Enter name of school...">
              </div>
